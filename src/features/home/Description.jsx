...
const Description = () => (
  <div className="description-container">
    <div className="description-section">
      ...
      <h6>Easy To Use</h6>
      <p>Upload your image and choose your desired format, adjust quality to your taste. It's as simple as that!</p>
    </div>
    ...
    <div className="description-section">
      ...
      <p>Everything happens on your device. Your images are never uploaded anywhere — Konva runs entirely in your browser.</p>
    </div>
  </div>
);
